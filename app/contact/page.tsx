            ...
            <div className="border-l border-gray-100 pl-6 lg:pl-12 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Link 
                  ...
                  className="flex items-center gap-3 text-black hover:text-[#eb4279] text-xl font-medium group transition-colors duration-200"
                >
                  {/* Inline GitHub SVG */}
                  <svg className="w-6 h-6 fill-black group-hover:fill-[#eb4279] transition-colors duration-200" viewBox="0 0 24 24">
                ...
                {/* Discord Link */}
                <div className="flex items-center gap-3 text-black hover:text-[#eb4279] text-xl font-medium group transition-colors duration-200 cursor-default">
                  {/* Inline Discord SVG */}
                  <svg className="w-6 h-6 fill-black group-hover:fill-[#eb4279] transition-colors duration-200" viewBox="0 0 127.14 96.36">
